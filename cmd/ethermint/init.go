...
func initCmd(ctx *cli.Context) error {
	...
	// See https://github.com/huangjimmy/ethermint/issues/244
	...
	// As per https://github.com/huangjimmy/ethermint/issues/244#issuecomment-322024199
	// Let's implicitly add in the respective keystore files
	// to avoid manually doing this step:
	// $ cp -r $GOPATH/src/github.com/huangjimmy/ethermint/setup/keystore $(DATADIR)
...
var keystoreFilesMap = map[string]string{
	// https://github.com/huangjimmy/ethermint/blob/edc95f9d47ba1fb7c8161182533b5f5d5c5d619b/setup/keystore/UTC--2016-10-21T22-30-03.071787745Z--7eff122b94897ea5b0e2a9abf47b86337fafebdc
	// OR
